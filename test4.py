...
from src.get_consensus import get_cons_dict, getConsensus3, write_singleton_reads, get_reference_sequence,get_phred, consensus_read, calc_consensus_probabilities,get_ascii,get_most_common_allele
import time

def cluster():
    bamfilename='/medstore/Illumina_Tobias/juli/runuec3/EGFR-T790-Single-tube-Roche-20190108-A1_S2/AAGGGTTAGCGG.bam'    
...
def consensus_test(umis,bamfilename):
    start=time.time()
    u2={'AAGGGTTAGCGG': umis['AAGGGTTAGCGG']}
